...
echo "1. Copy files to your-node1-hostname:/data/docker_configs/mariadb_galera/"
echo "   - docker-compose-host1.yml, galera-prd1.cnf, .env, init-scripts/"
echo "2. Copy files to your-node2-hostname:/data/docker_configs/mariadb_galera/"
echo "   - docker-compose-host2.yml, galera-prd2.cnf, .env, init-scripts/"
echo "3. On your-node1-hostname, run: docker compose -f docker-compose-host1.yml up -d"
echo "4. Wait for your-node1-hostname to fully initialize"
echo "5. On your-node2-hostname, run: docker compose -f docker-compose-host2.yml up -d"
echo
