...
### Node2 (your-node2-hostname)
```bash
docker stop mariadb-galera-node2
```

### Node1 (your-node1-hostname)
```bash
...
**Run from Node1 (your-node1-hostname)**
...
# Remote (node2)
ssh your-node2-hostname "docker stop mariadb-galera-node2"
```
...
# Node2
ssh your-node2-hostname "docker run --rm -v mariadb-galera-node2_mariadb_data:/data alpine cat /data/grastate.dat"
```
...
# Node2
ssh your-node2-hostname "docker run --rm -v mariadb-galera-node2_mariadb_data:/data alpine sh -c '
    rm -f /data/rsync_sst.conf
    rm -f /data/rsync_sst.pid
    rm -f /data/sst_in_progress
    rm -f /data/wsrep_sst.pid
...
### Step 6: Start Node2
```bash
ssh your-node2-hostname "docker start mariadb-galera-node2"
...
|------|------|-------|-----------|
| Node1 | your-node1-hostname | 10.87.2.22 | mariadb-galera-node1 |
| Node2 | your-node2-hostname | 10.87.2.23 | mariadb-galera-node2 |
